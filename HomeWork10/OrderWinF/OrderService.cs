...
namespace project1
{
    public class OrderService
    {
        ...
        public void AddOrder(string orderName,int orderDetailNu,string orderTel)
        {
            Order order = new Order(orderName, finalOrder, orderTel);
            try
            {
                Console.WriteLine("创建订单开始" + " " + "名称：" + orderName + " ");
